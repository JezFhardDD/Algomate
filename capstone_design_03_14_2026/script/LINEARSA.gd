...
const CURRENT_TOPIC = "linear_search"  # ADDED: For database tracking
...
func _start_assessment_mode():
	...
	# Kill any lingering block animations
...
# ==============================================
#   UNDO / REDO (UPDATED with timeline)
# ==============================================
...
func _show_result_popup(result: String, grade_data: Dictionary = {}) -> void:
	...
	if result == "PASS":
		...
		# ADDED: Explicitly hide code buttons on fail
		if translate_code_btn:
...
# ADDED: Try again root button handler
...
# ADDED: Time up popup button handlers
