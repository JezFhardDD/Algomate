...
const TEXTURE_POOL = [
	preload("res://assets/BLOCK_ORANGE.png"), # Index 0: Base Texture
...
func _ready() -> void:
	...
	# FIX: FORCE ORANGE TEXTURE (Index 0)
	# This ensures modulate colors apply cleanly without texture color interference.
