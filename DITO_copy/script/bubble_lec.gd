...
func _compile_code(code: String) -> void:
	...
	print("=== Bubble Sort Compile Request ===")
...
func _perform_sort_step():
	...
	if val_a > val_b:
		...
		_add_code_line("SWAP", sort_j, val_a)
...
func _gen_cpp_code() -> String:
	var code = "/* Bubble Sort Simulation - Operations Log */\n"
...
func _gen_python_code() -> String:
	...
	code += "    print(f'After pass {i+1}: ', end='')\n"
	code += "    print_array(arr)\n\n"
...
func _gen_java_code() -> String:
	...
	code += "public class BubbleSortSim {\n"
	...
	code += "                }\n"
	code += "            }\n"
	code += "            System.out.print(\"After pass \" + (i+1) + \": \");\n"
	code += "            printArray(arr);\n"
	code += "        }\n\n"
...
func _update_cpp_tutorial() -> void:
	...
	if cpp_text:
		var base_code = _generate_code_for_language(current_code_language)
